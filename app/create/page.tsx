          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-lg text-gray-600">
                Start your Q&A session in seconds. No setup required.
              </p>
            </div>
              ...
              <form onSubmit={handleCreate} className="space-y-6">
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                  <input
                    ...
                    disabled={loading}
                  />
                  <label htmlFor="authRequired" className="flex-1 cursor-pointer">
                    <span className="block text-sm font-semibold text-gray-900">
                      Require names for questions
                    </span>
                    <span className="block text-xs text-gray-600 mt-1">
                      Participants must enter their name when asking questions. Recommended for smaller groups.
                    </span>
                  </label>
                </div>

                {/* UPDATED SHINY CREATE SESSION BUTTON */}
                <button
                  type="submit"
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-gray-600 flex-1">
                      You'll get a unique 6-digit code to share with participants
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center flex-shrink-0 font-bold text-sm">
                    ...
                    <p className="text-sm text-gray-600 flex-1">
                      Participants join instantly without sign-up
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center flex-shrink-0 font-bold text-sm">
                    ...
                    <p className="text-sm text-gray-600 flex-1">
                      Questions and polls appear in real-time
                    </p>
                  </div>
                </div>
              </div>
